...
namespace spizian\EnvSet\Workers;

use spizian\EnvSet\Contracts\Formatter as EnvSetFormatterContract;
use spizian\EnvSet\Exceptions\UnableWriteToFileException;

class Writer implements \spizian\EnvSet\Contracts\Writer
{
